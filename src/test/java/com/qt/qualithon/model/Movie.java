...
public class Movie{
    ...
    /**
     * set movie IMDB rating name
     *
     * @param imdbRating movie imdbRating
     **/
    public void setImdbRating(String imdbRating){
        this.imdbRating = imdbRating;
    }
    /**
     * get movie imdbRating name
     *
     * @return    movie imdb Rating as string
     **/
    ...
    /**
     * set movie IMDB Rotten Tomato rating name
     *
     * @param rottenTomatoRating movie imdbRottenTomatoRating
     **/
    public void setRottenTomatoRating(String rottenTomatoRating){
